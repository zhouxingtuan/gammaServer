...
typedef typename HandlerDestinationGroup::CreateFunction CreateFunctionHandler;
typedef typename HandlerDestinationGroup::DestroyFunction DestroyFunctionHandler;
